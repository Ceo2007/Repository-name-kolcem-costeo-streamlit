...
with tabs[0]:
    ...
    if pyg.get("ok"):
        ...
        pyg_table = pd.DataFrame([
            ...
            {"Línea": "Utilidad sin diferencia en cambio no realizada", "Valor": pyg.get("Utilidad sin diferencia en cambio no realizada", 0), "Lectura": "Lectura más conservadora: elimina utilidad contable sin caja por FX no realizada"},
