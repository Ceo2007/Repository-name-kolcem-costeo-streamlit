...
st.markdown('<div class="subtitle">Primero P&G contable; después resultado operativo, costeo por kg, precio defendible, conciliación y alertas. Sin ruido visual.</div>', unsafe_allow_html=True)
