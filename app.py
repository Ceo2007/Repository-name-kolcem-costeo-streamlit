...
with tabs[14]:
    ...
    with fx3:
        kpi("Utilidad final contable", money(utilidad_total_final_contable), help_text=f"Margen final: {pct(margen_total_final_contable)}", tone="red" if utilidad_total_final_contable < 0 else "green")
    with fx4:
        kpi("Utilidad final / ton", money(utilidad_total_final_contable_ton), help_text="Incluye no realizada", tone="red" if utilidad_total_final_contable_ton < 0 else "green")
    ...
    utilidad_real_unitaria = pd.DataFrame([
        ...
        ["Utilidad final contable", "Resultado final", utilidad_total_final_contable, safe_div(utilidad_total_final_contable, ton_vendida), safe_div(utilidad_total_final_contable, kg_vendido), safe_div(utilidad_total_final_contable, und_vendida), "Utilidad después de extraordinarios y diferencia en cambio no realizada"],
